...
//#endif
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "M3 Texturas - Claino!", nullptr, nullptr);
	...
	int nVerts;
	GLuint VAO = loadSimpleOBJ("SuzanneTriTextured.obj", nVerts,glm::vec3(0,0,0));
