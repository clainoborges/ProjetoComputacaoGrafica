...
//#endif
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "M6 - Adicionando Trajetorias - Claino", nullptr, nullptr);
	...
	std::vector<glm::vec3> controlPoints = generateControlPointsSet("arq.txt");
